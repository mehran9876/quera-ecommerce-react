...
const dummyProducts = [
  {
    ...
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS0JMP1RRgfGZbb2b62sXX72zC7zylKZHQC1w&s",
    price: 100000,
    rating: "5",
    stock: "10",
    count: "52",
...
const UserHomePage = () => {
  ...
  return (
    <div className=" p-6 flex flex-col">
      ...
      <div className="flex flex-row-reverse gap-20 mb-8">
       ...
       <div className="grid grid-cols-2 gap-4 relative">
          {mockProducts.slice(0, 4).map((product) => (
            <div key={product.id} className="relative ">
              ...
              <div className="absolute bottom-[-7px] left-[-40px] scale-[0.6]">
      ...
      <div className="grid grid-cols-4 gap-14 ">
        {mockProducts.slice(0, 4).map((product) => (
          <div key={product.id} className="relative">
            ...
            image={product.image}
             />
            <div className="absolute bottom-[-7px] left-[-80px] scale-[0.6]">
                <Badge text={`${product.price} تومان`}/>
            </div>
          </div>
        ))}
